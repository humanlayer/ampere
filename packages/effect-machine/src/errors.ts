...
export class DuplicateActorError extends Schema.TaggedError<DuplicateActorError>()('DuplicateActorError', {
	actorId: Schema.String,
}) {}

/** Operation requires schemas attached to machine */
export class MissingSchemaError extends Schema.TaggedError<MissingSchemaError>()('MissingSchemaError', {
...
export class SlotProvisionError extends Schema.TaggedError<SlotProvisionError>()('SlotProvisionError', {
...
export class ActorStoppedError extends Schema.TaggedError<ActorStoppedError>()('ActorStoppedError', {
	actorId: Schema.String,
}) {}
